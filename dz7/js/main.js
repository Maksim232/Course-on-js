...
const app = new Vue({
    ...
    methods: {
        ...
        filter() {
            let regexp = new RegExp(this.userSearch, 'i'); //добавил к прошлой функции лишь this для обращения к объекту и убрал из filter() - userSearch, т.е то что функция принимает на обработку
